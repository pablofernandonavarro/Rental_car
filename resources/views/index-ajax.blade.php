    ...
    <div class="content-area">
                                                                    ...
                                                                    <div class="container-fluid">
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <div class="form-group has-icon has-label">
                                                                                ...
                                                                                <input type="text" class="form-control" id="formSearchOffDate" placeholder="dd/mm/yyyy">
                                                                                <span class="form-control-icon"><i class="fa fa-calendar"></i></span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-3">
                                                            ...
                                                            <div class="container-fluid">
                                                                <div class="col-sm-7">
                                                                    <div class="form-group has-icon has-label">
                                                                        ...
                                                                        <input type="text" class="form-control" id="formSearchUpDate2" placeholder="dd/mm/yyyy">
                                                                        <span class="form-control-icon"><i class="fa fa-calendar"></i></span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-5">
                                                            ...
                                                            <div class="container-fluid">
                                                                <div class="col-sm-7">
                                                                    <div class="form-group has-icon has-label">
                                                                        ...
                                                                        <input type="text" class="form-control" id="formSearchOffDate2" placeholder="dd/mm/yyyy">
                                                                        <span class="form-control-icon"><i class="fa fa-calendar"></i></span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-5">
                                                            ...
                                                            <div class="container-fluid">
                                                                <div class="col-sm-7">
                                                                    <div class="form-group has-icon has-label">
                                                                        ...
                                                                        <input type="text" class="form-control" id="formSearchOffDate3" placeholder="dd/mm/yyyy">
                                                                        <span class="form-control-icon"><i class="fa fa-calendar"></i></span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-5">
        ...
        <section class="page-section">
            <div class="container">
                ...
                <div class="tabs awesome">
                    <ul id="tabs1" class="nav"><!--
                        --><li class=""><a href="ajax-tabx1.blade.php" data-target="#tab-x1" data-toggle="tabajax">Economic cars</a></li><!--
                        --><li class="active"><a href="ajax-tabx2.blade.php" data-target="#tab-x2" data-toggle="tabajax">Business cars</a></li><!--
                        --><li class=""><a href="{{ asset('/resources/views/ajax-tabx3.blade.php')}}" data-target="#tab-x3" data-toggle="tabajax">Premium cars</a></li><!--
                        --><li class=""><a href="ajax-tabx4.blade.php" data-target="#tab-x4" data-toggle="tabajax">Luxury cars</a></li>
                    </ul>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <p class="btn-row text-center">
                            <a href="#" class="btn btn-theme ripple-effect btn-icon-left facebook"><i class="fa fa-facebook"></i>FACEBOOK</a>
                            <a href="#" class="btn btn-theme btn-icon-left ripple-effect twitter"><i class="fa fa-twitter"></i>TWITTER</a>
                            <a href="#" class="btn btn-theme btn-icon-left ripple-effect pinterest"><i class="fa fa-pinterest"></i>PINTEREST</a>
                            <a href="#" class="btn btn-theme btn-icon-left ripple-effect google"><i class="fa fa-google"></i>GOOGLE</a>
                        </p>
